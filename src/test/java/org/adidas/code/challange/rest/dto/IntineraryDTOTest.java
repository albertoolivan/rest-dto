...
public class IntineraryDTOTest {
	...
	public void compareIntineraryDTOTest() {
		...
		// test
		assertEquals("IntineraryDTO [path=[], sumPathWeight=0, message=null, departureTime=null, arrivalTime=null]", intineraryDTO1.toString());
		assertEquals("IntineraryDTO [path=[], sumPathWeight=1, message=Message, departureTime=2019-07-10T10:30, arrivalTime=null]", intineraryDTO3.toString());
